...
export const getAllTimeline = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://backend-portfolio-2-ibw1.onrender.com/api/timeline/getall",
...
export const addNewTimeline = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://backend-portfolio-2-ibw1.onrender.com/api/timeline/add",
      data,
      {
        withCredentials: true,
...
export const deleteTimeline = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://backend-portfolio-2-ibw1.onrender.com/api/timeline/delete/${id}`,
      {
        withCredentials: true,
      }
    );
